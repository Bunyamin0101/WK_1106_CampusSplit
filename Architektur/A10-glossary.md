...
| **CSRF** | Cross-Site Request Forgery. Angriffsmuster, bei dem ein Browser zu unerwünschten Anfragen verleitet wird. Bei den in CampusSplit verwendeten Session-Cookies (siehe ADR-010) wird dagegen der Standard-CSRF-Schutz von Spring Security für Thymeleaf-Formulare genutzt. |
